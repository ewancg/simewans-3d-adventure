...
Error Input::centerMousePos() {
  ...
  SDL_WarpMouseInWindow(handle, static_cast<float>(window.width()) / 2.F,
                        static_cast<float>(window.height()) / 2.F);
  return {};
}
